...
public class ContactNoViewHolder extends RecyclerView.ViewHolder {
    ...
    ContactNoAdapter adapter;
    ImageView cross;
    int position;

    public ContactNoViewHolder(@NonNull View itemView) {
        super(itemView);
        parent = itemView;
    ...
    public void setData(Context context, ContactNo item, CreditLimitCallback callback, int position, ContactNoAdapter adapter) {
        this.adapter = adapter;
        this.position = position;
        email.setText(item.getNumber());
