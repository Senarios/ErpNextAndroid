...
public class StockLedgerRepo implements OnNetworkResponse {

    private static StockLedgerRepo instance;
    ...
    public static StockLedgerRepo getInstance() {
        if (instance == null) {
            instance = new StockLedgerRepo();
        }
        return instance;
    }
    ...
    public void onSuccess(Call call, Response response, Object tag) throws ParseException {
        if ((int) tag == RequestCodes.API.DOCTYPE) {
            ...
            if (res != null && res.getReport() != null && res.getReport().getName() != null) {
                ...
                getStokeReport("Stock Ledger", jsonObject);
