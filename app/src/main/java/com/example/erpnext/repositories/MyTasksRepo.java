...
public class MyTasksRepo implements OnNetworkResponse {
    private static MyTasksRepo instance;
    ...
    public static MyTasksRepo getInstance() {
        if (instance == null) {
            instance = new MyTasksRepo();
        }
        return instance;
    }
//    public static MyTasksRepo getInstance() {
//        MyTasksRepo instance = new MyTasksRepo();
//        return instance;
//    }
    ...
    public void changeMyTasksStatus(String doctype, String names, String action) {
        if (Utils.isNetworkAvailable()) changeStatus(doctype, names, action);
            ...
            Notify.Toast("Your invoice will be " + body.getAction() + "ed when internet will be available");
        }
    }
