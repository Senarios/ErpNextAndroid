...
public class AddPurchaseReceiptRepo implements OnNetworkResponse {
    private static AddPurchaseReceiptRepo instance;
    ...
    public static AddPurchaseReceiptRepo getInstance() {
        if (instance == null) {
            instance = new AddPurchaseReceiptRepo();
        }
        return instance;
    }
    ...
    public void getSearchLink(int requestCode, String searchDoctype, String query, String filters) {
        NetworkCall.make()
                ...
                .enque(Network.apis().getSearchLinkWithFilters(new SearchLinkWithFiltersRequestBody("", searchDoctype, "0", filters, "Purchase Receipt", query)))
                .execute();
    }
