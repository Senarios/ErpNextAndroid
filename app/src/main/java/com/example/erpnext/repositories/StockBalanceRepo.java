...
public class StockBalanceRepo implements OnNetworkResponse {

    private static StockBalanceRepo instance;
    ...
    public static StockBalanceRepo getInstance() {
        if (instance == null) {
            instance = new StockBalanceRepo();
        }
        return instance;
    }
