...
public class AddTerritoryRepo implements OnNetworkResponse {
    private static AddTerritoryRepo instance;
    ...
    public static AddTerritoryRepo getInstance() {
        if (instance == null) {
            instance = new AddTerritoryRepo();
        }
        return instance;
    }
    ...
    public void getSearchLink(int requestCode, String searchDoctype, String query, String filters) {
        NetworkCall.make()
                ...
                .enque(Network.apis().getSearchLinkWithFilters(new SearchLinkWithFiltersRequestBody("", searchDoctype, "0", filters, "Territory", query)))
                .execute();
    }
    ...
    public void onSuccess(Call call, Response response, Object tag) throws ParseException {
        ...
        } else if ((int) tag == RequestCodes.API.LINK_SEARCH_PARENT_TERRITORY) {
        ...
        } else if ((int) tag == RequestCodes.API.LINK_SEARCH_TERRITORY_MANAGER) {
            SearchLinkResponse res = (SearchLinkResponse) response.body();
            if (res != null && res.getResults() != null) {
                res.setRequestCode(0);
                res.setRequestCode((int) tag);
        ...
        } else if ((int) tag == RequestCodes.API.TERRITORY_TARGETS_ITEM_GROUP) {
            SearchLinkResponse res = (SearchLinkResponse) response.body();
            if (res != null && res.getResults() != null) {
                res.setRequestCode(0);
                res.setRequestCode((int) tag);
        ...
        } else if ((int) tag == RequestCodes.API.TERRITORY_TARGETS_FISCAL_YEAR) {
            SearchLinkResponse res = (SearchLinkResponse) response.body();
            if (res != null && res.getResults() != null) {
                res.setRequestCode(0);
                res.setRequestCode((int) tag);
        ...
        } else if ((int) tag == RequestCodes.API.TERRITORY_TARGETS_TARGET_DISTRIBUTION) {
            SearchLinkResponse res = (SearchLinkResponse) response.body();
            if (res != null && res.getResults() != null) {
                res.setRequestCode(0);
                res.setRequestCode((int) tag);
