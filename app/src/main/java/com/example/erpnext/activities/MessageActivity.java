...
import com.example.erpnext.chatroom.APIService;
import com.example.erpnext.chatroom.Chat;
import com.example.erpnext.chatroom.MessageAdapter;
import com.example.erpnext.chatroom.User;
import com.example.erpnext.chatroom.chatnotification.Client;
import com.example.erpnext.chatroom.chatnotification.Data;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_send.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!msg.equals("")){
                    ...
                    Toast.makeText(MessageActivity.this, R.string.cannot_empty_message, Toast.LENGTH_SHORT).show();
                }
                text_send.setText("");
            }
        });
        ...
        reference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                String[] onlyName = email.split("@");
                username.setText(onlyName[0]);
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    apiService.sendNotification(sender).enqueue(new retrofit2.Callback<MyResponse>() {
                        @Override
