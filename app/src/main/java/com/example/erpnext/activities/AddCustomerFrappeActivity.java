...
import com.example.erpnext.databinding.ActivityAddContactBindingImpl;
import com.example.erpnext.databinding.ActivityAddCustomerFrappeBinding;
...
import com.example.erpnext.viewmodels.AddCustomerFrappeViewModel;
...
public class AddCustomerFrappeActivity extends AppCompatActivity {
//public class AddCustomerFrappeActivity extends AppCompatActivity implements View.OnClickListener, AddNewTerritoryCallBack {

    public static HashMap<String, String> data = new HashMap<String, String>();
    AddCustomerFrappeViewModel mViewModel;
    ActivityAddCustomerFrappeBinding binding;
    ImageView back;
    Button save;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = DataBindingUtil.setContentView(this, R.layout.activity_add_customer_frappe);
        mViewModel = new ViewModelProvider(this).get(AddCustomerFrappeViewModel.class);
