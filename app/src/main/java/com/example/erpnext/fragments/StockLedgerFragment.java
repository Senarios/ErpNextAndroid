...
import com.example.erpnext.viewmodels.StockLedgerViewModel;

public class StockLedgerFragment extends Fragment implements View.OnClickListener, DateTime.datePickerCallback {

    StockLedgerFragmentBinding binding;
    TextView fromDate, toDate;
    String clickedDate;
    AutoCompleteTextView warehouse, item;
    private StockLedgerViewModel mViewModel;

    public static StockLedgerFragment newInstance() {
        return new StockLedgerFragment();
    }

    @Override
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
                             @Nullable Bundle savedInstanceState) {
        mViewModel = new ViewModelProvider(this).get(StockLedgerViewModel.class);
        binding = StockLedgerFragmentBinding.inflate(inflater, container, false);
