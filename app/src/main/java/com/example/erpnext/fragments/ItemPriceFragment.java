...
import com.example.erpnext.activities.AddItemPriceActivity;
import com.example.erpnext.adapters.StockListsAdapter;
import com.example.erpnext.app.MainApp;
import com.example.erpnext.callbacks.ProfilesCallback;
import com.example.erpnext.databinding.ItemPriceFragmentBinding;
import com.example.erpnext.repositories.ItemPriceRepo;
import com.example.erpnext.utils.RequestCodes;
import com.example.erpnext.utils.Utils;
import com.example.erpnext.viewmodels.ItemPriceViewModel;

import java.util.ArrayList;
import java.util.List;

public class ItemPriceFragment extends Fragment implements View.OnClickListener, ProfilesCallback {

    public boolean isItemsEnded = false;
    String doctype = "Item Price";
    ItemPriceFragmentBinding binding;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        binding = ItemPriceFragmentBinding.inflate(inflater, container, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.back:
                ...
                break;
            case R.id.add_new:
                startActivityForResult(new Intent(getActivity(), AddItemPriceActivity.class), RequestCodes.ADD_ITEM_PRICE);
                break;
        }
    }
