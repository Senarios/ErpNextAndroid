...
public class StockBalanceFragment extends Fragment implements View.OnClickListener, DateTime.datePickerCallback {

    StockBalanceFragmentBinding binding;
    TextView fromDate, toDate;
    String clickedDate;
    AutoCompleteTextView warehouse, item;
    private StockBalanceViewModel mViewModel;

    public static StockBalanceFragment newInstance() {
        return new StockBalanceFragment();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mViewModel = new ViewModelProvider(this).get(StockBalanceViewModel.class);
        MainApp.INSTANCE.setCurrentActivity(getActivity());
        binding = StockBalanceFragmentBinding.inflate(inflater, container, false);
    ...
    private void setObservers() {
        ...
        mViewModel.getReport().observe(getActivity(), reportResponse -> {
            if (reportResponse != null && reportResponse.getMessage().getColumns() != null) {
                ...
                Notify.Toast(getString(R.string.no_record_found));
            }
        });
    }
