...
import com.example.erpnext.roomDB.TypeConverters.FieldListConverter;
import com.example.erpnext.roomDB.TypeConverters.PermissionListConverter;
...
@Entity
@TypeConverters({FieldListConverter.class, PermissionListConverter.class})
public class Doc {
