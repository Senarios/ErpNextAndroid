...
@Entity
@TypeConverters(ObjectsListConverter.class)
public class ItemDetail {
    ...
    @Expose
    private Integer lastPurchaseRate;
    ...
    @SerializedName("validate_applied_rule")
    @Expose
    private Integer validateAppliedRule;
    @SerializedName("price_or_product_discount")
    @Expose
    private String priceOrProductDiscount;
    @SerializedName("pricing_rule_for")
    @Expose
    private String pricingRuleFor;
    @SerializedName("margin_type")
    @Expose
    @Embedded
    private Object marginType;
    @SerializedName("margin_rate_or_amount")
    @Expose
    private Double marginRateOrAmount;
    @SerializedName("has_pricing_rule")
    @Expose
    private Integer hasPricingRule;
    ...
    public Integer getLastPurchaseRate() {
        return lastPurchaseRate;
    }

    public void setLastPurchaseRate(Integer lastPurchaseRate) {
    ...
    public Integer getValidateAppliedRule() {
        return validateAppliedRule;
    }

    public void setValidateAppliedRule(Integer validateAppliedRule) {
        this.validateAppliedRule = validateAppliedRule;
    }

    public String getPriceOrProductDiscount() {
        return priceOrProductDiscount;
    }

    public void setPriceOrProductDiscount(String priceOrProductDiscount) {
        this.priceOrProductDiscount = priceOrProductDiscount;
    }

    public String getPricingRuleFor() {
        return pricingRuleFor;
    }

    public void setPricingRuleFor(String pricingRuleFor) {
        this.pricingRuleFor = pricingRuleFor;
    }

    public Object getMarginType() {
        return marginType;
    }

    public void setMarginType(Object marginType) {
    ...
    public Integer getHasPricingRule() {
        return hasPricingRule;
    }

    public void setHasPricingRule(Integer hasPricingRule) {
        this.hasPricingRule = hasPricingRule;
    }
